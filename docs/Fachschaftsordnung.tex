...
% PDF-Metadaten
\hypersetup{
	pdfauthor={Fachschaftsvertretung Physik der Universität Münster},
	pdftitle={Fachschaftsordnung der Fachschaft Physik der Universität Münster},
...
% Kopfzeile
\ihead{Fachschaftsordnung der Fachschaft Physik der Universität Münster}
...
\date{in der Fassung vom \DTMdate{2024-04-24}}
\author{}
...
\section{Einführung von Dauerbeschlüssen}
\begin{enumerate}
...
\begin{enumerate}
	\item Der FSR unterhält einen E-Mail-Verteiler: \email{fsphys-l@listserv.uni-muenster.de}, sowie einen Mattermostkanal: Fsphys..
...
Die Fachschaftsordnung der Fachschaft Physik der Universität Münster wird durch Votum mit Zweidrittelmehrheit der Mitglieder der Fachschaftsvertretung beschlossen und tritt durch öffentlichen Aushang am \DTMdate{2024-04-24} in Kraft.

\includepdf[pages=-,pagecommand={},scale=0.9]{Muster-GO.pdf}
