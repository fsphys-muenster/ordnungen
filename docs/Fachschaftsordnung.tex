...
\begin{enumerate}
	...
	\item Bei Anträgen auf Auszahlung von Beträgen unter 20\,€ kann abweichend von \ref{sec:finanzen} Abs.~\ref{item:finanzen_beschluss} auf einen Beschluss eines Gremiums der Fachschaft Physik verzichtet werden, sofern bis zu dem Zeitpunkt, zu dem der Gegenstand des Antrages benötigt wird, keine Sitzung eines Gremiums der Fachschaft Physik stattfindet.
\end{enumerate}
...
Die Fachschaftsordnung der Fachschaft Physik der Westfälischen Wilhelms-Universität Münster wird durch Votum mit Zweidrittelmehrheit der Mitglieder der Fachschaftsvertretung beschlossen und tritt durch öffentlichen Aushang am \DTMdate{2017-07-26} am Folgetag in Kraft.
