...
% PDF-Metadaten
\hypersetup{
	pdfauthor={Fachschaftsrat Physik der WWU Münster},
	pdftitle={Geschäftsordnung des Fachschaftsrats Physik der Westfälischen Wilhelms-Universität Münster},
	pdfkeywords={Fachschaftsrat, FSR, WWU, Münster, Geschäftsordnung}
}

% Kopfzeile
\ihead{Geschäftsordnung des FSR Physik der Westfälischen Wilhelms-Universität Münster}
...
\date{in der Fassung vom \DTMdate{2017-01-11}}
\author{}
...
\begin{enumerate}
	\item Jedes FSR-Mitglied besitzt eine Stimme.
	Stimmberechtigt sind alle gewählten Mitglieder des FSR.
	Der FSR kann weiteren Mitgliedern der Fachschaft das Stimmrecht erteilen.
	...
	\item Ist eine Angelegenheit wegen Beschlussunfähigkeit zurückgestellt worden, so ist der FSR in der zur Beratung derselben Angelegenheit einberufenen Sondersitzung unabhängig von der Zahl der erschienenen Mitglieder beschlussfähig.
	...
	Soweit der FSR den Änderungsanträgen zustimmt oder sie von der Antragstellerin oder dem Antragsteller übernommen werden, wird der Hauptantrag in der geänderten Fassung zur Abstimmung gestellt.
	\item Im Normalfall wird in der FSR-Sitzung durch Handzeichen abgestimmt.
...
\begin{enumerate}
	...
	\item Das vollständige Protokoll wird auf dem Netzlaufwerk des FSR archiviert.
	...
	\item Das Protokoll gilt als genehmigt, wenn zu Beginn der folgenden FSR-Sitzung gemäß \ref{sec:Durchführung} Abs. ~\ref{item:Sitzungsbeginn} keine Gegenrede erhoben wird.
	\item Protokolle enthalten mindestens
	\begin{enumerate}
	\item den Beginn und das Ende der Sitzung,
	\item Anwesende bei der Sitzung und gegebenenfalls deren verspätetes Eintreffen oder
vorzeitiges Verlassen der Sitzung,
	\item Antragstexte oder eindeutige Verweise auf die Anträge,
	\item Abstimmungsergebnisse,
	\item Anträge zur Geschäftsordnung und deren Behandlung und
	\item Sondervoten.
	\end{enumerate}
\end{enumerate}
...
Die Geschäftsordnung des Fachschaftsrats Physik der Westfälischen Wilhelms-Universität Münster tritt durch Beschluss des Fachschaftsrats am \DTMdate{2017-01-11} in Kraft.
