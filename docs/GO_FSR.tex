...
\begin{enumerate}
	\item Der FSR stimmt über Voten des FSR auf der FK ab.
	Bei einer Enthaltungsmehrheit bei einer Abstimmung über ein Votum zu einem Antrag, der an die FK gestellt wurde, enthält sich der FSR abweichend von \ref{sec:abstimmungen} Abs.~\ref{item:abstimmungsmodus} der Stimme auf der FK.
